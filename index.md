...
carpentry: "Explore Music Features using Librosa"    # what kind of Carpentry (must be either "lc" or "dc" or "swc").  
                      # Be sure to update the Carpentry type in _config.yml as well.  
venue: "Oslo"        # brief name of host site without address (e.g., "Euphoric State University")
